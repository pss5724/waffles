...
var menulist = ["http://localhost:10000/waffles/images/waffle/딸기듬뿍와플.jpg",
				...
				"http://localhost:10000/waffles/images/waffle/싸만코젤라또와플.jpg",
				"http://localhost:10000/waffles/images/waffle/애플시나몬와플.png",
				];
var i;
text = "";
...
<body>
	...
	<div class="menu-bar">
		...
		<a href="#"><label>☆ </label><label>와플</label></a>
		<a href="#"><label>☆ </label><label>커피 / 라떼</label></a>
		<a href="#"><label>☆ </label><label>쥬스 / 차</label></a>
	</div>
	<div class="p">
