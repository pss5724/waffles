...
<style>
	...
	div.content>section:nth-child(2) div {
		text-align : center;
	}
	
	div.content>section:nth-child(2) div:nth-child(1) {
		color : orange;
		font-weight : bold;
	}
	
	div.content>section:nth-child(2) div:nth-child(2) {
		font-size : 24px;
		font-weight : 700;
		color : dimgray;
		margin-top : 10px;
	...
	div.content>section:nth-child(2) div:nth-child(3), div.content>section:nth-child(2) div:nth-child(4) {
		color : dimgray;
		font-size : 14px;
		font-weight : bold;
	}
